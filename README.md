...
[![Docker Automated build](https://img.shields.io/docker/automated/chris-short/docker-centos6-ansible.svg?maxAge=2592000)](https://hub.docker.com/r/chris-short/docker-centos6-ansible/)
...
## How to Use
  ...
  1. [Install Docker](https://docs.docker.com/engine/installation/).
  2. Pull this image from Docker Hub: `docker pull chrisshort/docker-centos6-ansible:latest` (or use the tag you built earlier, e.g. `centos6-ansible`).
